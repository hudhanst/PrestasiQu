        ...
        <center>
          <table id="myTable">
            <tr>
              ...
              <th onclick="SortStringData(5)" width="39%">prestasi</th>                            
...
if($fetchresault->num_rows>0){
  while($row = $fetchresault->fetch_assoc()) {
    ...
    echo "<td><input type='button' name='accp' value='terima' id=".$row['iPrestasiId']." class='accp_view' onclick='model8()'/></td>";              
    echo "</tr>";
  ...
  <div class="AccPrestasiModal">
    ...
    <div id="myModal8" class="modal">
      ...
      <div class="modal-content">
        ...
        <h1>Terima Prestasi</h1>
        

        <div id="AccPrestasiModal"></div>
      </div>
    </div>
  </div>
...
$(document).ready(function () {
    $('.accp_view').click(function () {
      var PrestasiAccId = $(this).attr("id");
      var UserId = "<?php echo $_SESSION['ID']?>";
      $.ajax({
        url: "PHP/modals.php",
        method: "post",
        data: {
          PrestasiAccId: PrestasiAccId,
          UserId: UserId

        },
        success: function (data) {
          $('#AccPrestasiModal').html(data);
