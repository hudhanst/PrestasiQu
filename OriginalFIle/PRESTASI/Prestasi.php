...
<body>
  <div class="DataSiswa">
    <div class="Container">
      ...
      <div class="SearchBox">
      <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Cari Nama Prestasi" title="Type in a name">
      ...
      Katagori<br>
      <center>
      <input type="text" name="katagori" placeholder="Cari berdasarkan katagori"><br>
      </center>
      Tingakat Prestasi<br>
      <center>
      <input type="text" name="tingkatprestasi" placeholder="Cari berdasarkan tingkatan"><br>
      </center>
      Lembaga Yang Memberikan<br>
      <center>
      <input type="text" name="lembaga" placeholder="Cari berdasarkan lembaga yang memberikan"><br>
      </center>
      Tahun Diterima<br>
        ...
        <center>
          <table id="myTable1">
            <tr>
              ...
              <th onclick="SortStringData1(3)" width="19%">Nama Pengaju</th>                            
              <th onclick="SortStringData1(4)" width="19%">Nama yang Dituju</th>                            
              <th onclick="SortStringData1(5)" width="40%">Nama Prestasi</th>                            
              <th onclick="SortStringData1(6)" width="19%">Tanggal Pengajuan</th>                            
              <th width="1%">VIEW</th>
            </tr>
            <?php
$fetchsql = "SELECT * FROM prestasi_prestasi WHERE vcStatus='DLY'";
...
?>
        ...
        <h3 onclick="hiddendata1()" id="h3triger">Daftar Prestasi</h3><hr>
        <div id="hiddendata1">
        <center>
          <table id="myTable">
            <tr>
              ...
              <th onclick="SortStringData(5)" width="40%">Nama Prestasi</th>                            
            ...
            if(isset($_POST['searching'])){
              ...
              if(empty($tahunakhir)){
                $fetchsql = "SELECT * FROM prestasi_prestasi WHERE vcDitujuNama LIKE '%$namamurid%' AND vcKatagori LIKE '%$katagori%' AND vcTingkatPrestasi LIKE '%$tingkatprestasi%' AND vcLembagaPemberi LIKE '%$lembaga%' AND dtDIterima >= '$tahunawal' AND vcStatus='ACC'";
              }else{
              $fetchsql = "SELECT * FROM prestasi_prestasi WHERE vcDitujuNama LIKE '%$namamurid%' AND vcKatagori LIKE '%$katagori%' AND vcTingkatPrestasi LIKE '%$tingkatprestasi%' AND vcLembagaPemberi LIKE '%$lembaga%' AND dtDIterima >= '$tahunawal' AND dtDIterima <= '$tahunakhir' AND vcStatus='ACC'";
              }
      //  echo $nisn;      
            }else{
$fetchsql = "SELECT * FROM prestasi_prestasi WHERE vcStatus='ACC'";
            ...
            <?php
              ...
              if($fetchresault->num_rows>0){
                while($row = $fetchresault->fetch_assoc()) {
                  ...
                  echo "<td><input type='button' name='Prestasi' value='Prestasi' id=".$row['iBiodataId']." class='Prestasi_data' onclick='model6()'/></td>";  
                  echo "</tr>";
