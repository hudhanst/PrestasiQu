...
<body>
  <div class="DataGuru">
    <div class="Container">
        ...
        <center>
          <table id="myTable">
            <tr>
              ...
              <th onclick="SortNumberData(2)" width="5%">NIS</th>
              <th onclick="SortStringData(3)" width="50%">Nama Guru</th>                            
              <th width="1%">VIEW</th>
              <th width="25%">EDIT</th>
      ...
      $fetchsql = "SELECT * FROM prestasi_biodata WHERE iNomerInduk LIKE '%$nis%' AND vcStatus='guru'";
      //  echo $nisn;      
            }else{
        $fetchsql = "SELECT * FROM prestasi_biodata WHERE vcStatus='guru' OR vcStatus='GURU'";
            }
// $fetchsql = "SELECT * FROM prestasi_biodata WHERE vcStatus='guru' OR vcStatus='GURU'";
      ...
      <div class="modal-content">
        ...
        <form method="POST" action="PHP/proses.php">
          ...
          <li>
            ...
            <li>
              Nama Guru<br>
               <input type="text" id="" name="TBNamaGuru" placeholder="Masukkan Nama Guru:"
                required>
            </li>
            <li>
              Agama<br>
          ...
          <input type="submit" name="FormTambahDataGuru">
        </form>
      </div>
    </div>
  </div>
  ...
  <div class="HapusGuruModal">
    ...
    <div id="myModal2" class="modal">
      ...
      <div class="modal-content">
        ...
        <div id="DeleteGuruModal"></div>
      </div>
    </div>
  </div>

  <div class="VieweGuruModal">
    <!-- The Modal -->
    <div id="myModal3" class="modal">
      ...
      <div class="modal-content">
        ...
        <h1>View Data Guru</h1>
        

        <div id="VieweGuruModal"></div>
      </div>
    </div>
  </div>
...
<script>
  $(document).ready(function () {
    $('.updatee_data').click(function () {
      var UpdateDataGuruId = $(this).attr("id");
      $.ajax({
        url: "PHP/modals.php",
        method: "post",
        data: {
          UpdateDataGuruId: UpdateDataGuruId
        },
  ...
  $(document).ready(function () {
    $('.deletee_data').click(function () {
      var DeleteDataGuruId = $(this).attr("id");
      $.ajax({
        url: "PHP/modals.php",
        method: "post",
        data: {
          DeleteDataGuruId: DeleteDataGuruId
        },
        success: function (data) {
          $('#DeleteGuruModal').html(data);
          //  $('#dataModal').modal("show");  
        }
      });
    });
  ...
  $(document).ready(function () {
    $('.viewe_data').click(function () {
      var VieweDataGuruId = $(this).attr("id");
      $.ajax({
        url: "PHP/modals.php",
        method: "post",
        data: {
          VieweDataGuruId: VieweDataGuruId
        },
        success: function (data) {
          $('#VieweGuruModal').html(data);
          //  $('#dataModal').modal("show");  
        }
      });
    });
